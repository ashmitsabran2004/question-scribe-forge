...
import { FileUp, BookOpen, Clock, Award } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  <label htmlFor="max-time" className="text-sm font-medium flex items-center gap-1">
                ...
                <div className="space-y-2">
                  <label htmlFor="marks" className="text-sm font-medium flex items-center gap-1">
